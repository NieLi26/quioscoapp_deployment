        ...
        <Layout pagina='Total y Confirma Pedido'>
            ...
            >
                ...
                <div className="mt-5">
                    <input 
                        type="submit"
                        className={`${comprobarPedido() ? 'bg-indigo-100' : 'bg-indigo-600 hover:bg-indigo-800'} cursor-pointer disabled:cursor-not-allowed w-full lg:w-auto px-5 py-2 rounded uppercase font-bold text-white text-center`}
