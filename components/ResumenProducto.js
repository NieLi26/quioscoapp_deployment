  ...
  return (
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
        ...
        <div>
            <button
                type="button"
                className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-fol uppercase shadow-md w-full"
            ...
            <button
                type="button"
                className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-fol uppercase shadow-md w-full mt-3"
